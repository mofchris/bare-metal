...
| instruction             | m1/02          | one primitive step of machine work — add these, load that, jump if zero                                                  |
...
| latency                 | m1/03          | time for one round trip — measured in nanoseconds                                                                        |
...
| ZeRO                                      | m5/04          | forward ref (M9): split optimizer state across GPUs instead of copying it to each            |
