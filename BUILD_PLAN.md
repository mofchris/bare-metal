...
> **D-014** | Stage B | *Chose SQLite over JSON files for progress data.*
...
* Proposed tech stack with a justification per choice *against my constraints*
...
* Manual (me): a week of real daily use logged here before sign-off — the gate
  includes *me actually studying*, not just clicking around
...
* Automated: simulator outputs respond to parameter changes in the correct
  *direction and rough magnitude* (e.g., bigger batch → higher throughput,
  higher latency)
